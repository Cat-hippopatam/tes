  ...
  return (
    <div className="min-h-screen bg-[#F8F6F3]">
      <div className="container mx-auto px-4 py-8">
        <h1 className="text-3xl font-bold text-[#264653] mb-2">Панель администратора</h1>
        <p className="text-[#6C757D] mb-8">Управление платформой Economikus</p>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mb-8">
          <div className="bg-white rounded-xl border border-gray-200 p-6">
            <div className="flex items-center gap-4">
              ...
              <div>
                <p className="text-sm text-[#6C757D]">Пользователей</p>
                <p className="text-2xl font-bold text-[#264653]">{stats.totalUsers}</p>
              </div>
            </div>
          </div>
          ...
          <div className="bg-white rounded-xl border border-gray-200 p-6">
            <div className="flex items-center gap-4">
              ...
              <div>
                <p className="text-sm text-[#6C757D]">Контента</p>
                <p className="text-2xl font-bold text-[#264653]">{stats.totalContent}</p>
              </div>
            </div>
          </div>
          ...
          <div className="bg-white rounded-xl border border-gray-200 p-6">
            <div className="flex items-center gap-4">
              ...
              <div>
                <p className="text-sm text-[#6C757D]">На модерации</p>
                <p className="text-2xl font-bold text-[#264653]">{stats.pendingModeration}</p>
              </div>
            </div>
          </div>
        </div>
              ...
              <div className="flex items-start gap-4">
                ...
                <div className="flex-1">
                  <div className="flex items-center gap-2">
                    <h3 className="font-semibold text-[#264653] group-hover:text-[#F4A261] transition-colors">
                      {section.title}
                    </h3>
                  ...
                  <p className="text-sm text-[#6C757D] mt-1">{section.description}</p>
                </div>
              </div>
            </Link>
          ))}
